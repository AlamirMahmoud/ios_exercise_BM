...
class MoviesListViewModelTests: XCTestCase {
    ...
    class UpComingMoviesUseCaseMock: UpComingMoviesUseCase {
        var executeCallCount: Int = 0

        typealias ExecuteBlock = (
            UpComingMoviesUseCaseRequestValue,
            (MoviesPage) -> Void,
            (Result<MoviesPage, Error>) -> Void
        ) -> Void
    ...
    class TopRatedMoviesUseCaseMock: TopRatedMoviesUseCase {
        var executeCallCount: Int = 0
    ...
    class PopularMoviesUseCaseMock: PopularMoviesUseCase {
        var executeCallCount: Int = 0

        typealias ExecuteBlock = (
            PopularMoviesUseCaseRequestValue,
            (MoviesPage) -> Void,
            (Result<MoviesPage, Error>) -> Void
        ) -> Void
    ...
    func test_whenSearchMoviesUseCaseRetrievesEmptyPage_thenViewModelIsEmpty() {
        ...
        let upComingMoviesUseCaseMock = UpComingMoviesUseCaseMock()
        
        let popularMoviesUseCase = PopularMoviesUseCaseMock()
        let topRatedMoviesUseCase = TopRatedMoviesUseCaseMock()
        ...
        let viewModel = DefaultMoviesListViewModel(
            ...
            upComingMoviesUseCase: upComingMoviesUseCaseMock,
    ...
    func test_whenSearchMoviesUseCaseRetrievesFirstAndSecondPage_thenViewModelContainsTwoPages() {
        ...
        let searchMoviesUseCaseMock = SearchMoviesUseCaseMock()
        let upComingMoviesUseCaseMock = UpComingMoviesUseCaseMock()
        let popularMoviesUseCaseMock = PopularMoviesUseCaseMock()
        let topRatedMoviesUseCaseMock = TopRatedMoviesUseCaseMock()
        ...
        let viewModel = DefaultMoviesListViewModel.make(
            searchMoviesUseCase: searchMoviesUseCaseMock,
            upComingMoviesUseCaseMock: upComingMoviesUseCaseMock,
            popularMoviesUseCase: popularMoviesUseCaseMock,
            topRatedMoviesUseCase: topRatedMoviesUseCaseMock
        )
        // when
        viewModel.didSearch(query: "query")
        XCTAssertEqual(searchMoviesUseCaseMock.executeCallCount, 1)
...
extension DefaultMoviesListViewModel {
    static func make(
     ...
     upComingMoviesUseCaseMock : UpComingMoviesUseCase,
        popularMoviesUseCase : PopularMoviesUseCase,
        topRatedMoviesUseCase : TopRatedMoviesUseCase
        ...
        DefaultMoviesListViewModel(
            searchMoviesUseCase: searchMoviesUseCase,
            upComingMoviesUseCase: upComingMoviesUseCaseMock,
            topRatedMoviesUseCase: topRatedMoviesUseCase, popularMoviesUseCase: popularMoviesUseCase,
            mainQueue: DispatchQueueTypeMock()
        )
    }
}
