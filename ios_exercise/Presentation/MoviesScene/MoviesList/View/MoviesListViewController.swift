...
final class MoviesListViewController: UIViewController, StoryboardInstantiable, Alertable {
    ...
    @IBOutlet var upComingTap: UIStackView!
    @IBOutlet var topRatedTap: UIStackView!
    @IBOutlet var popularTap: UIStackView!
    ...
    private func setupTabBar(){
        upComingTap.addAction = { [self] in
            title = "Upcoming"
            viewModel.didSelectTap(type: .upcoming)
        }
        
        topRatedTap.addAction = { [self] in
            title = "Top Rated"
            viewModel.didSelectTap(type: .topRated)
        }
        
        popularTap.addAction = { [self] in
            title = "Popular"
            viewModel.didSelectTap(type: .upcoming)
        }
    }
