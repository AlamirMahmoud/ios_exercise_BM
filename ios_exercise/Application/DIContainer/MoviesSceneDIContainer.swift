...
final class MoviesSceneDIContainer: MoviesSearchFlowCoordinatorDependencies {
    ...
    func makeUpComingMoviesUseCase() -> UpComingMoviesUseCase {
        DefaultUpComingMoviesUseCase(
            moviesRepository: makeMoviesRepository(),
            moviesQueriesRepository: makeMoviesQueriesRepository()
        )
    }
    ...
    func makePopularMoviesUseCase() -> PopularMoviesUseCase {
    ...
    // MARK: - Movies List
    func makeMoviesListViewController(actions: MoviesListVMActions) -> MoviesListViewController {
    ...
    func makeMoviesListViewModel(actions: MoviesListVMActions) -> MoviesListViewModel {
        DefaultMoviesListViewModel(
            searchMoviesUseCase: makeSearchMoviesUseCase(), 
            upComingMoviesUseCase: makeUpComingMoviesUseCase(),
            topRatedMoviesUseCase: makeTopRatedMoviesUseCase(),
            popularMoviesUseCase: makePopularMoviesUseCase(),
            actions: actions
        )
    }
